...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    private let robotOne = Robot(matchingHandle: handleOne, color: UIColor.purple)
    private let robotTwo = Robot(matchingHandle: handleTwo, color: UIColor.blue)
    private let robotThree = Robot(matchingHandle: handleThree, color: UIColor.green)
    private let robotFour = Robot(matchingHandle: handleFour, color: UIColor.yellow)
